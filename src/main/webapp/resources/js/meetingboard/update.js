...
const updateFormModalOpenBtn = document.querySelector("#updateFormModalOpenBtn"); //수정폼 버튼
...
kakao.maps.event.addListener(clickMarker, 'click', function(){
    let openUpdateForm = confirm("이 장소로 모임을 만들까요?");
...
/*****************************************************/
// 모집글 작성 버튼 관련
const updateFormModalSendBtn = document.querySelector("#updateFormModalSendBtn"); //모달 전송 버튼
...
updateFormModalSendBtn.addEventListener("click", function(){
...
const updateFormModalCloseBtn = document.querySelector("#updateFormModalCloseBtn");
updateFormModalCloseBtn.addEventListener("click", function(){
    clearUpdateModalForm();
    this.click();
});

const updateFormModalCloseBottomBtn = document.querySelector("#updateFormModalCloseBottomBtn");
updateFormModalCloseBottomBtn.addEventListener("click", function(){
    clearUpdateModalForm();
    this.click();
})
