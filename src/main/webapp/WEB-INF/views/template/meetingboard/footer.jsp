	...
	<footer class="py-3 my-4 bg-light">
		<div class="row container-fluid">
			<div class="container pt-2 px-5 col-lg-7 col-md-12" id="divFooter">
	          ...
	          <p class="text-start text-muted"><span class="footerBoldText">담당자</span> 김남진 권경문</p>
			...
			<div class="container col-lg-5 d-lg-block d-md-none">
				<img src="/resources/images/stack-overflow.svg" alt="" id="subLogo"><span id="subLogoText">자소서</span>
			</div>
		</div>
	</footer>