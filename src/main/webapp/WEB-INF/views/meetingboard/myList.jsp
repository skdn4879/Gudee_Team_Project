...
<link rel="stylesheet" href="/resources/css/meetingboard/myList.css">
</head>
<body>
	...
	<section class="container-fluid" id="listSearchFrame">
		<div>
			<form method="get" action="./mylist" class="d-flex justify-contents-center align-items-center">
				
				<input type="hidden" name="hostMemberNum" value="${sessionScope.member.memberNum }">
		...
		<nav aria-label="Page navigation example">
		  <ul class="pagination justify-content-center">
		  	<li class="page-item ${pager.pre ? '' : 'disabled' }">
		  		<a class="page-link" href="./mylist?hostMemberNum=${sessionScope.member.memberNum }&page=${pager.startNum - 1 }&kind=${pager.kind}&search=${pager.search}" aria-label="Previous">
				   <span aria-hidden="true">&laquo;</span>
				</a>
		  	</li>
		    <c:forEach begin="${pager.startNum }" end="${pager.lastNum }" step="1" var="i">
		    	<li class="page-item"><a class="page-link" href="./mylist?hostMemberNum=${sessionScope.member.memberNum }&page=${i }&kind=${pager.kind}&search=${pager.search}">${i }</a></li>
		    </c:forEach>
		    <li class="page-item ${pager.next ? '' : 'disabled' }">
			   <a class="page-link" href="./mylist?hostMemberNum=${sessionScope.member.memberNum }&page=${pager.lastNum + 1 }&kind=${pager.kind}&search=${pager.search}" aria-label="Next">
	...
	<script src="/resources/js/meetingboard/myList.js"></script>
